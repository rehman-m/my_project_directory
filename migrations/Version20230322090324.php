 ...
 */
final class Version20230322090324 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE department CHANGE budget budget VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE department CHANGE budget budget INT NOT NULL');
    }
}
